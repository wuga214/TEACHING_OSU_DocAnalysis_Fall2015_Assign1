...
public class FileFinder {
	...
	public static void main(String[] args) {
		System.out.println("\nTest 1: ");
		for (File f : FileFinder.GetAllFiles("src/search/documents", ".txt", true)) 
			System.out.println("- " + f);
		
		System.out.println("\nTest 2: ");
		for (File f : FileFinder.GetAllFiles("src/search/documents", null, true)) 
			System.out.println("- " + f);

		System.out.println("\nTest 3: ");
		for (File f : FileFinder.GetAllFiles("src/search/documents", null, false)) 
			System.out.println("- " + f);
	}
